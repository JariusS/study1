...
songsList.append("ferst")
songsList.append("perfect")
songsList.append("any")
 ...
 */
songsList += ["songHit1", "songHit2", "songHit3", "songHit4"]
 ...
 */
print(songsList)
for numbetCurrentSonger in 0..<(songsList.count-1){
    print("Next song id your \(songsList[numbetCurrentSonger + 1])")
}
