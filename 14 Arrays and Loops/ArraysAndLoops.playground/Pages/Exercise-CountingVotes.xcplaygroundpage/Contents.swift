...
func countVoids(arry: [Bool]){
    ...
    //return voidNo; voidYes
    print("Void support = \(voidYes), and void against = \(voidNo)" )
}
countVoids(arry: shouldMascotChangeVotes)

countVoids(arry: shouldInstallCoffeeVendingMachineVotes)

countVoids(arry: shouldHaveMorePollOptionsVotes)
