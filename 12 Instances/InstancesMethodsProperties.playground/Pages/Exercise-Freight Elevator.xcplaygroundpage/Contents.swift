 ...
 */
let weightLess100 = 107
let weightBetween100And1000 = 500
let weightOver1000 = 2000
...
var ricketyRope = TreehousePulley(weightCapacity: 4000)
ricketyRope.addLoadToBasket(loadWeight: weightLess100 * 3)
ricketyRope.addLoadToBasket(loadWeight: weightBetween100And1000 * 2)
ricketyRope.addLoadToBasket(loadWeight: weightOver1000)

ricketyRope.canHandleAdditionalLoad(weightLess100)
