 ...
 */
//var votesForBeach = 0
//var votesForChocolateFactory = 0
//for votes in tripDestinationVotes{
//    switch votes {
//    case .beach:
//        votesForBeach += 1
//    default:
//        votesForChocolateFactory += 1
//    }
//
//}
//print(" votesForBeach = \(votesForBeach) \n votesForChocolateFactory = \(votesForChocolateFactory)")

func calculateVotes (votes: Array<ClassTripDestination>) -> String {
    var votesForBeach = 0
    var votesForChocolateFactory = 0
    for votes in tripDestinationVotes{
        switch votes {
    ...
    return " votesForBeach = \(votesForBeach) \n votesForChocolateFactory = \(votesForChocolateFactory)"
}

let results = calculateVotes(votes: tripDestinationVotes)
/*:
 ### Extension:
