...
let sentence2 = makeFavorite(categoryOfThing: "movie", favorite: "Home")
sentence2
let sentence3 = makeFavorite(categoryOfThing: "subject", favorite: "fizra")
sentence3
print(sentence3 + "\n" + sentence2 + "\n" + sentence)
print("Hello, my name is Euna. wetwqte( ...")
