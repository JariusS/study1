 ...
 */
func printHello(tom names: String) {
    print("Hello " + names)
}
printHello(tom: "Chris")
printHello(tom: "Johnny")
func summa(firstParametr: Int, twoParametr: Int) -> Int {
    return firstParametr + twoParametr
}
print(summa(firstParametr: 33, twoParametr: 67))
/*:
