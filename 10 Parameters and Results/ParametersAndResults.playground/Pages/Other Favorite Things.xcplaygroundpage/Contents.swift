...
*/
func printFavorite(categoryOfThing: String, favorinte: String){
    print("My favorite \(categoryOfThing) is \(favorinte)")
}
printFavorite(categoryOfThing: "game", favorinte: "ball")
