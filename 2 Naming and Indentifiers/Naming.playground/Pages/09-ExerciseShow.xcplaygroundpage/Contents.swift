...
let posterCost = 40
let totalTicketValut = numberOfTickets * ticketPrice
let totalExptnses = roomRentalFree + posterCost
let totalIncomeOfShow = (numberOfTickets * ticketPrice) - (roomRentalFree + posterCost)
